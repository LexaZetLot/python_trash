...
# reuse book examples
from Tools      import windows      # window border, exit protocols
from Tools      import threadtools  # thread callback queue checker
from Email import mailtools    # load,send,parse,build utilities
from TextEditor import textEditor   # component and pop up
